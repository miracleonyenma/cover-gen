      ...
      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
        ...
        <defs>
          ...
          <clipPath id="clip-path">
            <rect class="cls-1" width="1024" height="1024" rx="238.5" ry="238.5" />
          </clipPath>
        </defs>
        <title>mio-logo-fluent</title>
        <g class="cls-2">
          <rect class="cls-3" x="1.37" y="-46.34" width="1019.95" height="344.37" />
          <rect class="cls-4" x="2.1" y="214.68" width="1019.95" height="325.47" />
          <rect class="cls-5" x="2.83" y="475.7" width="1019.95" height="306.57" />
          <rect class="cls-6" x="3.56" y="736.72" width="1019.95" height="287.67" />
        </g>
        <path class="cls-7"
